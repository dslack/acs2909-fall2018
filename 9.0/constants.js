...
const LECTURES = [
    ...
    {
        lectureLink: lecturePath('week07/Week07.pdf'),
        lectureLabel: "Lecture 7",
        lectureExamplesLink: examplesPath('week07/Week07.zip'),
        lectureDetails: "Web Storage"
    }
    ,
    {
        lectureLink: lecturePath('week08/Week08.pdf'),
        lectureLabel: "Lecture 8",
        lectureExamplesLink: examplesPath('week08/Week08.zip'),
        lectureDetails: "Asynchronous Javascript, Webservices, JSON"
    }
]
